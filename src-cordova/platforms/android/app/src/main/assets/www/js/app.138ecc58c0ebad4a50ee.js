...
/* harmony default export */ var App = ({
  ...
  data: function data() {
    return {
      ...
      recievingAddress: 'hjdsgfhjdsgfjlhdsfajbkvgfkjhnas',
  ...
  beforeCreate: function beforeCreate() {
    ...
    document.addEventListener('deviceready', function () {
      window.nfc.addNdefListener(_this.onNdef, function () {
        console.log('Listening for NDEF tags.');
      }, function () {
        console.log('failed Listening for NDEF tags.');
      });

      window.nfc.addTagDiscoveredListener(_this.onNfc, function () {
        console.log('Listening for non-NDEF tags.');
      }, function () {
        console.log('failed Listening for non-NDEF tags.');
      });

      window.nfc.addMimeTypeListener(_this.nDefMimeType, _this.onNdef, function () {
        console.log('Listening for NDEF mime tags with type text/pg.');
      }, function () {
        console.log('failed Listening for NDEF mime tags with type text/pg.');
      });
    }, false);
  },
  ...
  methods: {
    onNdef: function onNdef(nfcEvent) {
      console.log(stringify_default()(nfcEvent.tag));

      if (nfcEvent.tag.serialNumber) {
        nfcEvent.tag.id = nfcEvent.tag.serialNumber;
        nfcEvent.tag.isWritable = !nfcEvent.tag.isLocked;
        nfcEvent.tag.canMakeReadOnly = nfcEvent.tag.isLockable;
      }
      console.log(nfcEvent.tag);
    },
    onNfc: function onNfc(nfcEvent) {
      console.log(stringify_default()(nfcEvent.tag));
      console.log(nfcEvent.tag);
    }
  }
...
//# sourceMappingURL=app.138ecc58c0ebad4a50ee.js.map