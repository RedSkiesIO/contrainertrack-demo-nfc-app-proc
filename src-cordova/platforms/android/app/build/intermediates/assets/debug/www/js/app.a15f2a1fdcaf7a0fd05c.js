  ...
  methods: {
    onNdef: function onNdef(nfcEvent) {
      ...
      if (nfcEvent.tag.serialNumber) {
        nfcEvent.tag.id = tag.serialNumber;
        nfcEvent.tag.isWritable = !tag.isLocked;
        nfcEvent.tag.canMakeReadOnly = tag.isLockable;
      }
      console.log(tag);
    },
...
//# sourceMappingURL=app.a15f2a1fdcaf7a0fd05c.js.map