...
/* harmony default export */ var App = ({
  ...
  beforeCreate: function beforeCreate() {
    ...
    document.addEventListener('deviceready', function () {
      window.nfc.addNdefListener(_this.log(payload), _this.log('listen addNdefListener successfull'), _this.log('listen addNdefListener failed'));
      window.nfc.addTagDiscoveredListener(_this.log(payload), _this.log('listen addTagDiscoveredListener successfull'), _this.log('listen addTagDiscoveredListener failed'));
    }, false);
  },
  created: function created() {
    window.nfc.share(this.recievingAddress, this.log('success started share'), this.log('failed to start share'));
  },
...
//# sourceMappingURL=app.8fcc41e21a5f4e213d65.js.map