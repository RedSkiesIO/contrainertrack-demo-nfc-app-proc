...
/* harmony default export */ var App = ({
  ...
  beforeCreate: function beforeCreate() {
    window.nfc.addNdefListener(this.onNdef, function () {
      console.log('Listening for NDEF tags.');
    }, function () {
      console.log('failed Listening for NDEF tags.');
    });

    window.nfc.addTagDiscoveredListener(this.onNfc, function () {
      console.log('Listening for non-NDEF tags.');
    }, function () {
      console.log('failed Listening for non-NDEF tags.');
    });

    window.nfc.addMimeTypeListener(this.nDefMimeType, this.onNdef, function () {
...
//# sourceMappingURL=app.22f8b896f467509898c8.js.map